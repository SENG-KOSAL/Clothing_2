<script setup>
  ...
  import shirt15 from "./assets/pant/comfortt trosers.jpg"
  import shirt16 from "./assets/pant/confort troiusers.jpg"
  import shirt17 from "./assets/pant/jooger 1.jpg"
  import shirt18 from "./assets/pant/jooger troussers.jpg"
  import shirt19 from "./assets/pant/striped jacquard.jpg"
  import shirt20 from "./assets/pant/striped jacuard 1.jpg"
  import shirt21 from "./assets/pant/wide fit pleated 1.jpg"
  import shirt22 from "./assets/pant/wide fit pleated.jpg"
  const posts = [
  { id: 1, img: shirt15, Name: "Classic Tee", price: 18 },
  { id: 2, img: shirt16, Name: "Vintage Polo", price: 25 },
  { id: 3, img: shirt17, Name: "Casual V-Neck", price: 22 },
  { id: 4, img: shirt18, Name: "Graphic T-Shirt", price: 20 },
  { id: 5, img: shirt19, Name: "Modern Fit Shirt", price: 30 },
  { id: 6, img: shirt20, Name: "Sporty Tank", price: 15 },
  { id: 7, img: shirt21, Name: "Relaxed Fit Tee", price: 24 },
  { id: 8, img: shirt22, Name: "Cotton Crewneck", price: 27 },
];
...
<template>
    ...
    <!-- //head_web_(home_man_woman_Promotion) -->
    <nav class="navbar">
